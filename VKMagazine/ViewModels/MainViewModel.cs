...
namespace VKMagazine.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public void LoadData()
        {
            ...
            this.Items.Add(new ItemViewModel() { LineOne = "Группы", LineTwo = "Maecenas praesent accumsan bibendum", LineThree = "Facilisi faucibus habitant inceptos interdum lobortis nascetur pharetra placerat pulvinar sagittis senectus sociosqu" });
